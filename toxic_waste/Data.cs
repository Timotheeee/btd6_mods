...
namespace toxic_waste
{
    class Data
    {
        ...
        public static Il2CppReferenceArray<AreaModel> areas()
        {
            ...
            newareas.Add(new AreaModel("lol1", new Assets.Scripts.Simulation.SMath.Polygon(areab), 10, (AreaType)0));
            ...
            newareas.Add(new AreaModel("lol0", new Assets.Scripts.Simulation.SMath.Polygon(area13), 10, (AreaType)1));
            ...
            newareas.Add(new AreaModel("lol1", new Assets.Scripts.Simulation.SMath.Polygon(area14), 10, (AreaType)1));
            ...
            newareas.Add(new AreaModel("lol0", new Assets.Scripts.Simulation.SMath.Polygon(area15), 10, (AreaType)1));
            ...
            newareas.Add(new AreaModel("lol17", new Assets.Scripts.Simulation.SMath.Polygon(area17), 10, (AreaType)0));
            ...
            newareas.Add(new AreaModel("lol18", new Assets.Scripts.Simulation.SMath.Polygon(area18), 10, (AreaType)0));
