...
namespace custom_maps
{
    class TrueTrueExpertData
    {
        ...
        public static Il2CppReferenceArray<AreaModel> areas()
        {
            ...
            newareas.Add(new AreaModel("lol0", new Assets.Scripts.Simulation.SMath.Polygon(areaa0), 1, (AreaType)2));
            ...
            newareas.Add(new AreaModel("lol12", new Assets.Scripts.Simulation.SMath.Polygon(area12), 10, (AreaType)2));
